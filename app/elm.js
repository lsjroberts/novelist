...
var _lsjroberts$novelist$Token_Types$zip = F2(
	function (xs, ys) {
		...
		if (_p0._0.ctor === '::') {
			if (_p0._1.ctor === '::') {
				return A2(
					...
					A2(_lsjroberts$novelist$Token_Types$zip, _p0._0._1, _p0._1._1));
			} else {
				return {
					ctor: '::',
					_0: _p0._0._0,
...
var _lsjroberts$novelist$Token_Types$tokensFromChildren = function (_p1) {
	var _p2 = _p1;
	return _p2._0;
};
var _lsjroberts$novelist$Token_Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {token: a, before: b, after: c, showTags: d, inner: e, children: f};
	});
var _lsjroberts$novelist$Token_Types$Text = {ctor: 'Text'};
var _lsjroberts$novelist$Token_Types$filterEmptyTextTokens = _elm_lang$core$List$filter(
	function (x) {
		if (_elm_lang$core$Native_Utils.eq(x.token, _lsjroberts$novelist$Token_Types$Text)) {
			var _p3 = x.inner;
			if (_p3.ctor === 'Just') {
				return (_elm_lang$core$Native_Utils.cmp(
...
var _lsjroberts$novelist$Token_Types$wrap2 = F5(
	function (left, right, inside, outside, string) {
		var exp = _elm_lang$core$Regex$regex(
			A2(
				_elm_lang$core$Basics_ops['++'],
				left,
		...
		var insides = A2(
			...
			A2(
				...
				A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, exp, string)));
		var outsides = _lsjroberts$novelist$Token_Types$filterEmptyTextTokens(
			A2(
				_elm_lang$core$List$map,
				outside,
				A3(_elm_lang$core$Regex$split, _elm_lang$core$Regex$All, exp, string)));
		return A2(_elm_lang$core$String$startsWith, left, string) ? A2(_lsjroberts$novelist$Token_Types$zip, insides, outsides) : A2(_lsjroberts$novelist$Token_Types$zip, outsides, insides);
	});
var _lsjroberts$novelist$Token_Types$wrap = function ($char) {
	return A2(_lsjroberts$novelist$Token_Types$wrap2, $char, $char);
};
var _lsjroberts$novelist$Token_Types$Emphasis = {ctor: 'Emphasis'};
var _lsjroberts$novelist$Token_Types$Speech = {ctor: 'Speech'};
var _lsjroberts$novelist$Token_Types$Paragraph = {ctor: 'Paragraph'};
var _lsjroberts$novelist$Token_Types$filterEmptyParagraphTokens = _elm_lang$core$List$filter(
	function (x) {
		return _elm_lang$core$Native_Utils.eq(x.token, _lsjroberts$novelist$Token_Types$Paragraph) ? (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(
				_lsjroberts$novelist$Token_Types$filterEmptyTextTokens(
					_lsjroberts$novelist$Token_Types$tokensFromChildren(x.children))),
			0) ? true : true) : true;
	});
var _lsjroberts$novelist$Token_Types$Children = function (a) {
	return {ctor: 'Children', _0: a};
};
var _lsjroberts$novelist$Token_Types$text = function (string) {
	return A6(
		_lsjroberts$novelist$Token_Types$Model,
		_lsjroberts$novelist$Token_Types$Text,
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$Maybe$Nothing,
		false,
		_elm_lang$core$Maybe$Just(string),
		_lsjroberts$novelist$Token_Types$Children(
			{ctor: '[]'}));
};
var _lsjroberts$novelist$Token_Types$markdownToTokens = function (string) {
	var cleanString = A4(
		...
		string);
	var tokens = A2(_elm_lang$core$String$contains, '\n', cleanString) ? A2(
		_elm_lang$core$List$map,
		_lsjroberts$novelist$Token_Types$paragraph,
		A2(_elm_lang$core$String$split, '\n', cleanString)) : (A2(_elm_lang$core$String$contains, '“', cleanString) ? A5(_lsjroberts$novelist$Token_Types$wrap2, '“', '”', _lsjroberts$novelist$Token_Types$speech, _lsjroberts$novelist$Token_Types$text, string) : (A2(_elm_lang$core$String$contains, '\"', cleanString) ? A4(_lsjroberts$novelist$Token_Types$wrap, '\"', _lsjroberts$novelist$Token_Types$speech, _lsjroberts$novelist$Token_Types$text, string) : (A2(_elm_lang$core$String$contains, '_', cleanString) ? A4(_lsjroberts$novelist$Token_Types$wrap, '_', _lsjroberts$novelist$Token_Types$emphasis, _lsjroberts$novelist$Token_Types$text, cleanString) : {
		ctor: '::',
		_0: _lsjroberts$novelist$Token_Types$text(cleanString),
		_1: {ctor: '[]'}
	})));
	return _lsjroberts$novelist$Token_Types$filterEmptyParagraphTokens(tokens);
};
var _lsjroberts$novelist$Token_Types$emphasis = function (string) {
	return A6(
		_lsjroberts$novelist$Token_Types$Model,
		_lsjroberts$novelist$Token_Types$Emphasis,
		_elm_lang$core$Maybe$Just('_'),
		_elm_lang$core$Maybe$Just('_'),
		false,
		_elm_lang$core$Maybe$Nothing,
		_lsjroberts$novelist$Token_Types$Children(
			_lsjroberts$novelist$Token_Types$markdownToTokens(
				A4(
					_elm_lang$core$Regex$replace,
					_elm_lang$core$Regex$All,
...
var _lsjroberts$novelist$Token_Types$paragraph = function (string) {
	return A6(
		_lsjroberts$novelist$Token_Types$Model,
		_lsjroberts$novelist$Token_Types$Paragraph,
		_elm_lang$core$Maybe$Nothing,
		...
		_elm_lang$core$Maybe$Nothing,
		_lsjroberts$novelist$Token_Types$Children(
			_lsjroberts$novelist$Token_Types$markdownToTokens(string)));
};
var _lsjroberts$novelist$Token_Types$speech = function (string) {
	return A6(
		_lsjroberts$novelist$Token_Types$Model,
		_lsjroberts$novelist$Token_Types$Speech,
...
var _lsjroberts$novelist$Token_Types$NoOp = {ctor: 'NoOp'};

var _lsjroberts$novelist$Scene_Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {name: a, content: b, commit: c, history: d, children: e, isWriting: f};
	});
var _lsjroberts$novelist$Scene_Types$Children = function (a) {
	return {ctor: 'Children', _0: a};
};
var _lsjroberts$novelist$Scene_Types$TokenMsg = function (a) {
	return {ctor: 'TokenMsg', _0: a};
};
var _lsjroberts$novelist$Scene_Types$Write = function (a) {
	return {ctor: 'Write', _0: a};
};
var _lsjroberts$novelist$Scene_Types$StartWriting = {ctor: 'StartWriting'};
var _lsjroberts$novelist$Scene_Types$SetName = function (a) {
...
var _lsjroberts$novelist$Welcome_Types$Model = F2(
	function (a, b) {
		return {projects: a, style: b};
	});
var _lsjroberts$novelist$Welcome_Types$NoOp = {ctor: 'NoOp'};

var _lsjroberts$novelist$Types$Model = F2(
	function (a, b) {
		return {scene: a, welcome: b};
	});
var _lsjroberts$novelist$Types$WelcomeMsg = function (a) {
	return {ctor: 'WelcomeMsg', _0: a};
};
var _lsjroberts$novelist$Types$SceneMsg = function (a) {
	return {ctor: 'SceneMsg', _0: a};
};

var _lsjroberts$novelist$Mocks_Austen$prideAndPrejudice = _lsjroberts$novelist$Token_Types$markdownToTokens(
	A2(
		_elm_lang$core$Basics_ops['++'],
																															...
																															A2(
																																...
																																A2(
																																	...
																																	A2(
																																		...
																																		A2(_elm_lang$core$Basics_ops['++'], '\nMr. Bennet was so odd a mixture of quick parts, sarcastic humour, reserve, and caprice, that the experience of three-and-twenty years had been insufficient to make his wife understand his character.', '\n_Her_ mind was less difficult to develop. She was a woman of mean understanding, little information, and uncertain temper. When she was discontented, she fancied herself nervous. The business of her life was to get her daughters married; its solace was visiting and news.')))))))))))))))))))))))))))))))))));

var _lsjroberts$novelist$Scene_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _lsjroberts$novelist$Scene_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Write':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							content: _lsjroberts$novelist$Token_Types$markdownToTokens(
								A2(_elm_lang$core$Debug$log, 'WRITE', _p0._0)),
							commit: model.commit + 1,
							history: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: model.commit, _1: model.content},
								_1: model.history
							},
							isWriting: false
						}),
...
var _lsjroberts$novelist$Scene_State$init = {
	ctor: '_Tuple2',
	_0: A6(
		_lsjroberts$novelist$Scene_Types$Model,
		'Chapter 1',
		_lsjroberts$novelist$Mocks_Austen$prideAndPrejudice,
		0,
		{ctor: '[]'},
		_lsjroberts$novelist$Scene_Types$Children(
			{ctor: '[]'}),
		false),
	_1: _elm_lang$core$Platform_Cmd$none
};

var _lsjroberts$novelist$Welcome_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _lsjroberts$novelist$Welcome_State$update = F2(
	function (action, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _lsjroberts$novelist$Welcome_State$init = {
	ctor: '_Tuple2',
	_0: A2(
		_lsjroberts$novelist$Welcome_Types$Model,
		{ctor: '[]'},
...
var _lsjroberts$novelist$State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _lsjroberts$novelist$State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'SceneMsg') {
			return A2(
				_etaque$elm_response$Response$mapCmd,
				_lsjroberts$novelist$Types$SceneMsg,
				A2(
					...
					A2(_lsjroberts$novelist$Scene_State$update, _p0._0, model.scene)));
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _lsjroberts$novelist$State$init = function () {
	var _p1 = _lsjroberts$novelist$Welcome_State$init;
	var welcome = _p1._0;
	var _p2 = _lsjroberts$novelist$Scene_State$init;
	var scene = _p2._0;
	return {
		ctor: '_Tuple2',
		_0: A2(_lsjroberts$novelist$Types$Model, scene, welcome),
		_1: _elm_lang$core$Platform_Cmd$none
	};
}();
...
var _lsjroberts$novelist$Styles$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};

var _lsjroberts$novelist$Token_View$text = function (token) {
	var _p0 = token.inner;
	if (_p0.ctor === 'Just') {
...
var _lsjroberts$novelist$Token_View$root = function (model) {
	var _p1 = model.token;
	switch (_p1.ctor) {
		case 'Paragraph':
			return _lsjroberts$novelist$Token_View$paragraph(model);
		case 'Speech':
			return _lsjroberts$novelist$Token_View$speech(model);
		case 'Emphasis':
			return _lsjroberts$novelist$Token_View$emphasis(model);
		default:
			return _lsjroberts$novelist$Token_View$text(model);
	}
};
var _lsjroberts$novelist$Token_View$emphasis = function (token) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _lsjroberts$novelist$Styles$styles(
				{
					ctor: '::',
		...
		_lsjroberts$novelist$Token_View$wrap(token));
};
var _lsjroberts$novelist$Token_View$wrap = function (token) {
	var after = function () {
		var _p2 = token.after;
		if (_p2.ctor === 'Just') {
			var _p3 = _p2._0;
			return token.showTags ? {
				ctor: '::',
	...
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_lsjroberts$novelist$Token_View$inner(token.children),
			after));
};
var _lsjroberts$novelist$Token_View$inner = function (_p6) {
	var _p7 = _p6;
	return A2(_elm_lang$core$List$map, _lsjroberts$novelist$Token_View$root, _p7._0);
};
var _lsjroberts$novelist$Token_View$paragraph = function (token) {
	return A2(
			...
			_0: _lsjroberts$novelist$Styles$styles(
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$textIndent(
...
var _lsjroberts$novelist$Token_View$speech = function (token) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _lsjroberts$novelist$Styles$styles(
				{
					...
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						A4(_rtfeldman$elm_css$Css$rgba, 0, 189, 156, 0.2)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _lsjroberts$novelist$Scene_View$textContentDecoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Json_Decode$field, 'textContent', _elm_lang$core$Json_Decode$string),
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Json_Decode$succeed('nope'),
			_1: {ctor: '[]'}
		}
	});
var _lsjroberts$novelist$Scene_View$childrenContentDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (nodes) {
		return A3(
			_elm_lang$core$List$foldl,
	...
	A2(
		...
		_elm_lang$core$Json_Decode$keyValuePairs(_lsjroberts$novelist$Scene_View$textContentDecoder)));
var _lsjroberts$novelist$Scene_View$targetTextContent = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'target',
	...
	_elm_lang$core$Json_Decode$string);
var _lsjroberts$novelist$Scene_View$sceneFont = _rtfeldman$elm_css$Css$fontFamilies(
	{
		ctor: '::',
		_0: 'Cochin',
		_1: {
...
var _lsjroberts$novelist$Scene_View$contentView = function (model) {
	return A3(
		...
		{ctor: '[]'},
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toString(model.commit),
				_1: A2(
					_elm_lang$html$Html$article,
					{
						...
						_0: _lsjroberts$novelist$Styles$styles(
							{
								ctor: '::',
								_0: _lsjroberts$novelist$Scene_View$sceneFont,
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onFocus(_lsjroberts$novelist$Scene_Types$StartWriting),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html_Events$on,
											'blur',
											A2(_elm_lang$core$Json_Decode$map, _lsjroberts$novelist$Scene_Types$Write, _lsjroberts$novelist$Scene_View$childrenContentDecoder)),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					A2(
						...
						function (x) {
							return A2(
								...
								_lsjroberts$novelist$Scene_Types$TokenMsg,
								_lsjroberts$novelist$Token_View$root(x));
						},
						model.content))
			},
			_1: {ctor: '[]'}
...
var _lsjroberts$novelist$Scene_View$nameView = function (model) {
	return A2(
...
var _lsjroberts$novelist$Scene_View$root = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _lsjroberts$novelist$Scene_View$nameView(model),
			_1: {
				ctor: '::',
				_0: _lsjroberts$novelist$Scene_View$contentView(model),
				_1: {
					ctor: '::',
...
var _lsjroberts$novelist$Welcome_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
					...
					_0: _lsjroberts$novelist$Styles$styles(
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$letterSpacing(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Novelist'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
						...
						_0: _lsjroberts$novelist$Styles$styles(
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									_rtfeldman$elm_css$Css$hex('8f3faf')),
								_1: {
									ctor: '::',
									_0: A2(
										_rtfeldman$elm_css$Css$padding2,
										_rtfeldman$elm_css$Css$px(19),
										_rtfeldman$elm_css$Css$px(29)),
									_1: {
										ctor: '::',
																	...
																	_0: _rtfeldman$elm_css$Css$hover(
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundColor(
																				_rtfeldman$elm_css$Css$hex('9c56b8')),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Start writing your first story'),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$width('17'),
									_1: {
										ctor: '::',
										...
										_elm_lang$svg$Svg$line,
										{
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$y2('16.5'),
														_1: {
															ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_elm_lang$svg$Svg$line,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$y1('32'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$x2('17'),
														_1: {
...
var _lsjroberts$novelist$View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_lsjroberts$novelist$Types$SceneMsg,
				_lsjroberts$novelist$Scene_View$root(model.scene)),
			_1: {ctor: '[]'}
		});
};

var _lsjroberts$novelist$Main$main = _elm_lang$html$Html$program(
	{init: _lsjroberts$novelist$State$init, view: _lsjroberts$novelist$View$root, update: _lsjroberts$novelist$State$update, subscriptions: _lsjroberts$novelist$State$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _lsjroberts$novelist$Main$main !== 'undefined') {
    _lsjroberts$novelist$Main$main(Elm['Main'], 'Main', undefined);
}
